...
/**
 * Chart.js charts: grades line chart, league history line chart and
 * pie / doughnut charts. Series data is provided via data attributes.
 */
...
function initPieChart(el) {
  ...
  const labelContainer =
    el.parentElement && el.parentElement.querySelector(".pieChartLabel");
  if (labelContainer) {
