...
import { dataFloat } from "../core/dom.js";

/**
 * Stadium overview page: draws the current seat occupancy onto the
 * `#stadium` canvas using the ratios provided via data attributes.
 */
