...
// Suppress the PHP version disclosure header on every application response.
// (Also enforced via expose_php=Off in the Docker PHP config.)
@header_remove('X-Powered-By');

// Composer autoloader (provides Twig and other managed dependencies).
// Generated by `composer install` in the application folder (see README).
