...
?>
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8'); ?>#item<?php echo $row["id"]; ?>" method="post" class="row"<?php 
...
?>>
	...
	<div class="d-flex gap-2 justify-content-center p-3">
		...
		<a class="btn btn-secondary" href="?site=<?php echo $site; ?>&entity=<?php echo $entity; ?>"><?php echo $i18n->getMessage("button_cancel"); ?></a>
	</div>
