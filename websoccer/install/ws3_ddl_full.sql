CREATE TABLE ws3_admin (
  ...
  passwort_neu VARCHAR(255) NULL,
  passwort_neu_angefordert INT(11) NOT NULL DEFAULT 0,
  passwort_salt VARCHAR(32) NULL,
...
INSERT INTO ws3_pages (type, language, content) VALUES
...
CREATE TABLE ws3_spieler (
  ...
  vertrag_gehalt INT(10) NOT NULL DEFAULT 0,
